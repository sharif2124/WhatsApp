...
import com.sharif.chatingapp.Adapters.ChatAdapter;
import com.sharif.chatingapp.Models.MessageModel;
import com.sharif.chatingapp.databinding.ActivityChatDetailsBinding;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.Date;

public class Chat_Details_Activity extends AppCompatActivity {
       ...
       final String senderId = auth.getUid();
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chat_Details_Activity.this,MainActivity.class);
